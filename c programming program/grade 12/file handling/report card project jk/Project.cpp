...
main(){
	...
	do{
		printf("\n---------------");
		printf("\nEnter 1 to enter data and 2 to check data and 3 to close : ");
		scanf("%d",&n);
		if(n==1)
		{
			Data_Entry();
			...
			printf("what would you like ko check \n");
			printf("to check all record in ascending order press 1 ;\n");
			printf("to check all list in descending order press 2 ;\n");;
			printf("to see the data of spicific data press 3 ;\n");
		}
			Print();
	}
	while(n==1);
